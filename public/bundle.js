...
var _jsxFileName = '/Users/mike/Public/www/test/src/index.js';
...
var _jsxFileName = '/Users/mike/Public/www/test/src/App.js',
    _desc,
    _value,
    _class,
    _descriptor,
...
var Cell = (0, _mobxReact.observer)(function (_ref) {
  var html = _ref.html,
...
var AppContainer = (_class = function AppContainer() {
  _classCallCheck(this, AppContainer);

  _initDefineProp(this, 'cellBody', _descriptor, this);

  _initDefineProp(this, 'handleClick', _descriptor2, this);
}, (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'cellBody', [_mobx.observable], {
  enumerable: true,
  initializer: function initializer() {
    return initialCell;
  }
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'handleClick', [_mobx.action], {
  enumerable: true,
  initializer: function initializer() {
    var _this = this;
    ...
    return function () {
      console.log('lol');
      _this.cellBody = cross;
    };
  }
})), _class);


var App = (0, _mobxReact.inject)('AppContainer')(function (_ref2) {
  var cellBody = _ref2.cellBody,
  ...
  return _react2.default.createElement(
    ...
    [1, 2, 3].map(function (row) {
      return _react2.default.createElement(
        ...
        [1, 2, 3].map(function (cell) {
          return _react2.default.createElement(Cell, {
            key: cell,
            onClick: function onClick() {
              return handleClick();
            },
            html: cellBody, __source: {
              fileName: _jsxFileName,
              lineNumber: 31
            }
          });
